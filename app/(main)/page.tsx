          ...
          <div className="md:hidden">
            <Drawer>
              <DrawerTrigger asChild>
                <Button variant="ghost" className="font-medium hover:bg-transparent cursor-pointer">
              ...
              <DrawerContent className="p-4 max-h-[50vh] overflow-y-auto">
                ...
                <FilterSidebar />
                <DrawerClose asChild>
                  <Button variant="outline" className="mt-4 w-full">Закрыть</Button>
                </DrawerClose>
              </DrawerContent>
            </Drawer>
          </div>
          {/* Сортировка всегда справа */}
          <SortSelect />
        </div>
        {/* Основной контент: фильтры + каталог */}
